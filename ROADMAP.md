# LinkMap - Vertical Tabs & Link Map Chrome Extension

## Vision
A high-end Chrome Extension that combines vertical tab management with tree-style visualization and a deep theming engine, delivered as a side-panel experience.
...
## Planned
- [ ] PRD: LinkMap — Vertical Tabs & Link Map Chrome Extension [prd-linkmap.md] (normal)
- [ ] PRD creation (high priority)
- [ ] Task list breakdown (high priority)
- [ ] Core extension scaffold (high priority)
- [ ] Vertical tabs panel (high priority)
- [ ] Tree-style visualization (high priority)
